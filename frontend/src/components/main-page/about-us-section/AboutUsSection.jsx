...
const AboutUsSection = ({ translation, aboutUs, showButton = true }) => {
  return (
        ...
        <div className="about-us-section-content">
          <div className="about-us-section-header">
            <div className="about-us-section-header-wrap">
              ...
              {
                showButton &&
                <Button additionalClass={'about-us-section-btn'} link={"/about-us"}>
                  {translation["Детальніше"]}
                </Button>
              }
            </div>
          ...
          {showButton &&
            <Button additionalClass={'about-us-info__link-mobile'} link={"/about-us"}>
              {translation["Детальніше"]}
            </Button>
          }
