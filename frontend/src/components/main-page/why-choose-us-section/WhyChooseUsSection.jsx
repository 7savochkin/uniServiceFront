...
const WhyChooseUsSection = () => (
        <section className="why-choose-us-section">
            <div className="container">
                <h2 className="why-choose-us-section-title">Чому обирають нас</h2>
                    ...
                    <div className="why-choose-us-section-items">
                        ...
                        <div className="why-choose-us-section-item">
                            ...
                            <div className="why-choose-us-section-item-content">
                                ...
                                <p className="why-choose-us-section-item-content__text">
                                    Спеціалізований транспорт та професійний підхід гарантують безпечну та своєчасну
                                    доставку компонентів та засобів ініціювання.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="why-choose-us-section-item">
                            ...
                            <div className="why-choose-us-section-item-content">
                                ...
                                <p className="why-choose-us-section-item-content__text">
                                    Наші фахівці мають великий досвід у проведенні буровибухових робіт та виробництві
                                    вибухових речовин
                                </p>
                            </div>
                        </div>
