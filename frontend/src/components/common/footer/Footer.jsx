        ...
        <div className="footer-content">
          ...
          <div className="footer-content-contacts">
            ...
            <div className="footer-content__links">
              <a href={contacts?.facebook} className="footer-content__link" target="_blank" rel="noreferrer">
              ...
              <a href={contacts?.instagram} className="footer-content__link" target="_blank" rel="noreferrer">
                <svg width="30" height="30" viewBox="0 0 30 30" fill="none"
                  xmlns="http://www.w3.org/2000/svg">
                  <rect width="30" height="30" fill="#00CCCC" />
              ...
              <a href={contacts?.telegram} className="footer-content__link" target="_blank" rel="noreferrer">
                <svg width="30" height="30" viewBox="0 0 30 30" fill="none"
                  xmlns="http://www.w3.org/2000/svg">
                  <rect width="30" height="30" fill="#00CCCC" />
                  <path
